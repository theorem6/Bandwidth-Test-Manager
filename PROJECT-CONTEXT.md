...
- **cron_schedule:** one of three supported cron expressions (hourly, daily at 06:05, or every 6 hours). Chosen from **Settings → Scheduled tests**; used by `netperf-scheduler start`. Legacy configs are normalized on load.
