...
- **Web UI asset paths:** the app mounts static files at `/static` and `/netperf/static` (Vite `base`). Test direct Uvicorn at `http://<host>:8080/`; use the Site URL behind nginx.
